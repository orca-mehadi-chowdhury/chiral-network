...
impl GethProcess {
    ...
    pub fn start(&mut self, data_dir: &str, miner_address: Option<&str>) -> Result<(), String> {
        ...
        // Bootstrap node
        let bootstrap_enode = "enode://b3ead5f07d0dbeda56023435a7c05877d67b055df3a8bf18f3d5f7c56873495cd4de5cf031ae9052827c043c12f1d30704088c79fb539c96834bfa74b78bf80b@20.85.124.187:30303";
